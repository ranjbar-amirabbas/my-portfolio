      ...
      <Reveal>
        <div className="relative overflow-hidden rounded-3xl border border-border/70 bg-card/60 p-7 sm:p-10">
          ...
          <div className="relative z-10 max-w-3xl space-y-5">
            ...
            <h2 id="contact-title" className="font-display text-3xl font-semibold leading-tight text-foreground sm:text-4xl">
              {contact.cta}
            </h2>
            <p className="text-base leading-relaxed text-muted-foreground sm:text-lg">{contact.description}</p>
